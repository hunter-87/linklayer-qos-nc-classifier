...
void AirFrame::setSnr(double snr_var)
{
...
void AirFrame::setLossRate(double lossRate_var)
{
...
void AirFrame::setPowRec(double powRec_var)
{
    this->powRec_var = powRec_var;
}
...
AirFrameExtended::AirFrameExtended(const AirFrameExtended& other) : AirFrame()
{
    setName(other.getName());
    operator=(other);
}
...
void AirFrameExtended::setCarrierFrequency(double carrierFrequency_var)
{
    this->carrierFrequency_var = carrierFrequency_var;
}
...
void AirFrameExtended::setBandwidth(double bandwidth_var)
{
    this->bandwidth_var = bandwidth_var;
}
...
void AirFrameExtended::setModulationType(const ModulationType& modulationType_var)
{
