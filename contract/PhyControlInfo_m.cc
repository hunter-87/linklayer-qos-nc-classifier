...
void PhyControlInfo::setAdativeSensitivity(bool adativeSensitivity_var)
{
    this->adativeSensitivity_var = adativeSensitivity_var;
}
...
void PhyControlInfo::setTransmitterPower(double transmitterPower_var)
{
    this->transmitterPower_var = transmitterPower_var;
}
