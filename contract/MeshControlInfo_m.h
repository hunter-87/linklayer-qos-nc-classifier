...
class MeshControlInfo : public ::Ieee802Ctrl
{
  ...
  public:
    ...
    virtual void setInputId(int inputId_var);
    virtual bool getPreviousFix() const;
    virtual void setPreviousFix(bool previousFix_var);
    ...
    virtual void setVectorAddress(unsigned int k, const Uint128& vectorAddress_var);
};
