//
// Generated file, do not edit! Created by opp_msgc 4.1 from linklayer/contract/ControlInfoBreakLink.msg.
//
...
ControlInfoBreakLink::ControlInfoBreakLink(const ControlInfoBreakLink& other) : cObject()
{
    operator=(other);
}
...
void ControlInfoBreakLink::setDest(const MACAddress& dest_var)
{
