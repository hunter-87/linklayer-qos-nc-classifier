...
Radio80211aControlInfo::Radio80211aControlInfo(const Radio80211aControlInfo& other) : cObject()
{
    operator=(other);
}
...
void Radio80211aControlInfo::setSnr(double snr_var)
{
...
void Radio80211aControlInfo::setLossRate(double lossRate_var)
{
    this->lossRate_var = lossRate_var;
}
...
void Radio80211aControlInfo::setRecPow(double recPow_var)
{
    this->recPow_var = recPow_var;
}
...
void Radio80211aControlInfo::setModulationType(const ModulationType& modulationType_var)
{
    this->modulationType_var = modulationType_var;
}
...
void Radio80211aControlInfo::setAirtimeMetric(bool airtimeMetric_var)
{
    this->airtimeMetric_var = airtimeMetric_var;
}
...
void Radio80211aControlInfo::setTestFrameDuration(double testFrameDuration_var)
{
    this->testFrameDuration_var = testFrameDuration_var;
}
...
void Radio80211aControlInfo::setTestFrameError(double testFrameError_var)
{
    this->testFrameError_var = testFrameError_var;
}
...
void Radio80211aControlInfo::setTestFrameSize(int testFrameSize_var)
{
    this->testFrameSize_var = testFrameSize_var;
}
