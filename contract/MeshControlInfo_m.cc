//
// Generated file, do not edit! Created by opp_msgc 4.1 from linklayer/contract/MeshControlInfo.msg.
//
...
MeshControlInfo::MeshControlInfo(const MeshControlInfo& other) : Ieee802Ctrl()
{
    vectorAddress_arraysize = 0;
    this->vectorAddress_var = 0;
    operator=(other);
...
void MeshControlInfo::setInputId(int inputId_var)
{
    this->inputId_var = inputId_var;
}
...
void MeshControlInfo::setPreviousFix(bool previousFix_var)
{
    this->previousFix_var = previousFix_var;
}
...
void MeshControlInfo::setVectorAddress(unsigned int k, const Uint128& vectorAddress_var)
{
    if (k>=vectorAddress_arraysize) throw cRuntimeError("Array of size %d indexed by %d", vectorAddress_arraysize, k);
