...
Ieee80211ActionFrameBody::Ieee80211ActionFrameBody(const Ieee80211ActionFrameBody& other) : Ieee80211FrameBody()
{
    operator=(other);
}
...
Ieee80211ActionHWMPFrameBody::Ieee80211ActionHWMPFrameBody(const Ieee80211ActionHWMPFrameBody& other) : Ieee80211ActionFrameBody()
{
    operator=(other);
}
...
void Ieee80211ActionHWMPFrameBody::setId(int id_var)
{
    this->id_var = id_var;
}
...
void Ieee80211ActionHWMPFrameBody::setFlags(unsigned char flags_var)
{
...
void Ieee80211ActionHWMPFrameBody::setHopsCount(unsigned char hopsCount_var)
{
    this->hopsCount_var = hopsCount_var;
}
...
void Ieee80211ActionHWMPFrameBody::setTTL(unsigned char TTL_var)
{
...
Ieee80211ActionRANNFrameBody::Ieee80211ActionRANNFrameBody(const Ieee80211ActionRANNFrameBody& other) : Ieee80211ActionHWMPFrameBody()
{
    operator=(other);
}
...
void Ieee80211ActionRANNFrameBody::setRoot(const MACAddress& root_var)
{
...
void Ieee80211ActionRANNFrameBody::setSeqNumber(unsigned int seqNumber_var)
{
...
void Ieee80211ActionRANNFrameBody::setInterval(unsigned int interval_var)
{
    this->interval_var = interval_var;
}
...
void Ieee80211ActionRANNFrameBody::setMetric(unsigned int metric_var)
{
    this->metric_var = metric_var;
}
...
Ieee80211ActionPREQFrameBody::Ieee80211ActionPREQFrameBody(const Ieee80211ActionPREQFrameBody& other) : Ieee80211ActionHWMPFrameBody()
{
    preqElem_arraysize = 0;
    this->preqElem_var = 0;
    operator=(other);
...
void Ieee80211ActionPREQFrameBody::setPathDiscoveryId(unsigned int pathDiscoveryId_var)
{
    this->pathDiscoveryId_var = pathDiscoveryId_var;
}
...
void Ieee80211ActionPREQFrameBody::setOriginator(const MACAddress& originator_var)
{
...
void Ieee80211ActionPREQFrameBody::setOriginatorSeqNumber(unsigned int originatorSeqNumber_var)
{
    this->originatorSeqNumber_var = originatorSeqNumber_var;
}
...
void Ieee80211ActionPREQFrameBody::setOriginatorExternalAddr(const MACAddress& originatorExternalAddr_var)
{
    this->originatorExternalAddr_var = originatorExternalAddr_var;
}
...
void Ieee80211ActionPREQFrameBody::setLifeTime(unsigned int lifeTime_var)
{
...
void Ieee80211ActionPREQFrameBody::setMetric(unsigned int metric_var)
{
    this->metric_var = metric_var;
}
...
void Ieee80211ActionPREQFrameBody::setTargetCount(unsigned char targetCount_var)
{
    this->targetCount_var = targetCount_var;
}
...
void Ieee80211ActionPREQFrameBody::setPreqElem(unsigned int k, const PREQElem& preqElem_var)
{
    if (k>=preqElem_arraysize) throw cRuntimeError("Array of size %d indexed by %d", preqElem_arraysize, k);
    this->preqElem_var[k]=preqElem_var;
}
...
Ieee80211ActionPREPFrameBody::Ieee80211ActionPREPFrameBody(const Ieee80211ActionPREPFrameBody& other) : Ieee80211ActionHWMPFrameBody()
{
    operator=(other);
}
...
void Ieee80211ActionPREPFrameBody::setTarget(const MACAddress& target_var)
{
...
void Ieee80211ActionPREPFrameBody::setTargetSeqNumber(unsigned int targetSeqNumber_var)
{
    this->targetSeqNumber_var = targetSeqNumber_var;
}
...
void Ieee80211ActionPREPFrameBody::setTagetExternalAddr(const MACAddress& tagetExternalAddr_var)
{
    this->tagetExternalAddr_var = tagetExternalAddr_var;
}
...
void Ieee80211ActionPREPFrameBody::setLifeTime(unsigned int lifeTime_var)
{
    this->lifeTime_var = lifeTime_var;
}
...
void Ieee80211ActionPREPFrameBody::setMetric(unsigned int metric_var)
{
    this->metric_var = metric_var;
}
...
void Ieee80211ActionPREPFrameBody::setOriginator(const MACAddress& originator_var)
{
    this->originator_var = originator_var;
}
...
void Ieee80211ActionPREPFrameBody::setOriginatorSeqNumber(unsigned int originatorSeqNumber_var)
{
    this->originatorSeqNumber_var = originatorSeqNumber_var;
}
...
Ieee80211ActionPERRFrameBody::Ieee80211ActionPERRFrameBody(const Ieee80211ActionPERRFrameBody& other) : Ieee80211ActionHWMPFrameBody()
{
    perrElem_arraysize = 0;
    this->perrElem_var = 0;
    operator=(other);
...
void Ieee80211ActionPERRFrameBody::setNumDestination(unsigned char numDestination_var)
{
    this->numDestination_var = numDestination_var;
}
...
void Ieee80211ActionPERRFrameBody::setPerrElem(unsigned int k, const PERRElem& perrElem_var)
{
    if (k>=perrElem_arraysize) throw cRuntimeError("Array of size %d indexed by %d", perrElem_arraysize, k);
    this->perrElem_var[k]=perrElem_var;
}
...
Ieee80211ActionGANNFrameBody::Ieee80211ActionGANNFrameBody(const Ieee80211ActionGANNFrameBody& other) : Ieee80211ActionHWMPFrameBody()
{
    operator=(other);
}
...
void Ieee80211ActionGANNFrameBody::setMeshGateAddress(const MACAddress& meshGateAddress_var)
{
    this->meshGateAddress_var = meshGateAddress_var;
}
...
void Ieee80211ActionGANNFrameBody::setMeshGateSeqNumber(unsigned int meshGateSeqNumber_var)
{
    this->meshGateSeqNumber_var = meshGateSeqNumber_var;
}
...
Ieee80211ActionFrame::Ieee80211ActionFrame(const Ieee80211ActionFrame& other) : Ieee80211ManagementFrame()
{
    setName(other.getName());
    operator=(other);
}
...
void Ieee80211ActionFrame::setBody(const Ieee80211ActionFrameBody& body_var)
{
    this->body_var = body_var;
}
...
Ieee80211ActionHWMPFrame::Ieee80211ActionHWMPFrame(const Ieee80211ActionHWMPFrame& other) : Ieee80211ActionFrame()
{
    setName(other.getName());
    operator=(other);
}
...
void Ieee80211ActionHWMPFrame::setBody(const Ieee80211ActionHWMPFrameBody& body_var)
{
    this->body_var = body_var;
}
...
Ieee80211ActionRANNFrame::Ieee80211ActionRANNFrame(const Ieee80211ActionRANNFrame& other) : Ieee80211ActionHWMPFrame()
{
    setName(other.getName());
    operator=(other);
}
...
void Ieee80211ActionRANNFrame::setBody(const Ieee80211ActionRANNFrameBody& body_var)
{
    this->body_var = body_var;
}
...
Ieee80211ActionPREQFrame::Ieee80211ActionPREQFrame(const Ieee80211ActionPREQFrame& other) : Ieee80211ActionHWMPFrame()
{
    setName(other.getName());
    operator=(other);
}
...
void Ieee80211ActionPREQFrame::setBody(const Ieee80211ActionPREQFrameBody& body_var)
{
    this->body_var = body_var;
}
...
Ieee80211ActionPREPFrame::Ieee80211ActionPREPFrame(const Ieee80211ActionPREPFrame& other) : Ieee80211ActionHWMPFrame()
{
    setName(other.getName());
    operator=(other);
}
...
void Ieee80211ActionPREPFrame::setBody(const Ieee80211ActionPREPFrameBody& body_var)
{
    this->body_var = body_var;
}
...
Ieee80211ActionPERRFrame::Ieee80211ActionPERRFrame(const Ieee80211ActionPERRFrame& other) : Ieee80211ActionHWMPFrame()
{
    setName(other.getName());
    operator=(other);
}
...
void Ieee80211ActionPERRFrame::setBody(const Ieee80211ActionPERRFrameBody& body_var)
{
    this->body_var = body_var;
}
...
Ieee80211ActionGANNFrame::Ieee80211ActionGANNFrame(const Ieee80211ActionGANNFrame& other) : Ieee80211ActionHWMPFrame()
{
    setName(other.getName());
    operator=(other);
}
...
void Ieee80211ActionGANNFrame::setBody(const Ieee80211ActionGANNFrameBody& body_var)
{
    this->body_var = body_var;
}
