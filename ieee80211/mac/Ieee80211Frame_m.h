...
class Ieee80211Frame : public ::cPacket
{
  ...
  public:
    ...
    virtual void setMACArrive(simtime_t MACArrive_var);
};
...
class Ieee80211ManagementFrame : public ::Ieee80211DataOrMgmtFrame
{
  ...
  public:
    ...
    virtual void setCategory(short Category_var);
};
...
class Ieee80211LBMSRequest : public ::Ieee80211DataOrMgmtFrame
{
  ...
  public:
    ...
    virtual void setElement(const LBMSRequestElement& element_var);
};
...
class Ieee80211LBMSReport : public ::Ieee80211DataOrMgmtFrame
{
  ...
  public:
    ...
    virtual void setElement(unsigned int k, const LBMSReportElement& element_var);
    virtual double getPacketLoss() const;
    virtual void setPacketLoss(double packetLoss_var);
...
class Ieee80211MeshFrame : public ::Ieee80211DataFrame
{
  ...
  public:
    ...
    virtual void setTTL(short TTL_var);
    virtual long getSeqNumber() const;
    virtual void setSeqNumber(long seqNumber_var);
    ...
    virtual void setFinalAddress(const MACAddress& finalAddress_var);
    virtual bool getIsFragment() const;
    virtual void setIsFragment(bool isFragment_var);
    virtual unsigned long getRealLength() const;
    virtual void setRealLength(unsigned long realLength_var);
};
 ...
 *     Ieee80211BlockAckFrameReq(const Ieee80211BlockAckFrameReq& other) : Ieee80211BlockAckFrameReq_Base(other.getName()) {operator=(other);}
 *     Ieee80211BlockAckFrameReq& operator=(const Ieee80211BlockAckFrameReq& other) {Ieee80211BlockAckFrameReq_Base::operator=(other); return *this;}
...
class Ieee80211BlockAckFrameReq_Base : public ::Ieee80211TwoAddressFrame
{
  ...
  public:
    ...
    virtual void setBarAckPolicy(bool barAckPolicy_var);
    virtual bool getMultiTid() const;
    virtual void setMultiTid(bool multiTid_var);
    virtual bool getCompressed() const;
    virtual void setCompressed(bool compressed_var);
    virtual unsigned short getTidInfo() const;
    virtual void setTidInfo(unsigned short tidInfo_var);
    virtual unsigned short getFragNumber() const;
    virtual void setFragNumber(unsigned short fragNumber_var);
    virtual unsigned short getStartingSequence() const;
    virtual void setStartingSequence(unsigned short startingSequence_var);
};
 ...
 *     Ieee80211BlockAckFrame(const Ieee80211BlockAckFrame& other) : Ieee80211BlockAckFrame_Base(other.getName()) {operator=(other);}
 *     Ieee80211BlockAckFrame& operator=(const Ieee80211BlockAckFrame& other) {Ieee80211BlockAckFrame_Base::operator=(other); return *this;}
...
class Ieee80211BlockAckFrame_Base : public ::Ieee80211TwoAddressFrame
{
  ...
  public:
    ...
    virtual void setBaAckPolicy(bool baAckPolicy_var);
    virtual bool getMultiTid() const;
    virtual void setMultiTid(bool multiTid_var);
    virtual bool getCompressed() const;
    virtual void setCompressed(bool compressed_var);
