//
// Generated file, do not edit! Created by opp_msgc 4.1 from linklayer/ieee80211/mac/Ieee80211Frame.msg.
//
...
void Ieee80211Frame::setMACArrive(simtime_t MACArrive_var)
{
    this->MACArrive_var = MACArrive_var;
}
...
void Ieee80211ManagementFrame::setCategory(short Category_var)
{
...
Ieee80211LBMSRequest::Ieee80211LBMSRequest(const Ieee80211LBMSRequest& other) : Ieee80211DataOrMgmtFrame()
{
    setName(other.getName());
    operator=(other);
}
...
void Ieee80211LBMSRequest::setElement(const LBMSRequestElement& element_var)
{
    this->element_var = element_var;
}
...
Ieee80211LBMSReport::Ieee80211LBMSReport(const Ieee80211LBMSReport& other) : Ieee80211DataOrMgmtFrame()
{
    setName(other.getName());
    element_arraysize = 0;
    this->element_var = 0;
...
void Ieee80211LBMSReport::setElement(unsigned int k, const LBMSReportElement& element_var)
{
    if (k>=element_arraysize) throw cRuntimeError("Array of size %d indexed by %d", element_arraysize, k);
    this->element_var[k]=element_var;
}
...
void Ieee80211LBMSReport::setPacketLoss(double packetLoss_var)
{
...
void Ieee80211LBMSReport::setSnr(double snr_var)
{
    this->snr_var = snr_var;
}
...
Ieee80211MeshFrame::Ieee80211MeshFrame(const Ieee80211MeshFrame& other) : Ieee80211DataFrame()
{
    setName(other.getName());
    operator=(other);
}
...
void Ieee80211MeshFrame::setTTL(short TTL_var)
{
...
void Ieee80211MeshFrame::setSeqNumber(long seqNumber_var)
{
...
void Ieee80211MeshFrame::setFinalAddress(const MACAddress& finalAddress_var)
{
    this->finalAddress_var = finalAddress_var;
}
...
void Ieee80211MeshFrame::setIsFragment(bool isFragment_var)
{
    this->isFragment_var = isFragment_var;
}
...
void Ieee80211MeshFrame::setRealLength(unsigned long realLength_var)
{
    this->realLength_var = realLength_var;
}
...
Ieee80211BlockAckFrameReq_Base::Ieee80211BlockAckFrameReq_Base(const Ieee80211BlockAckFrameReq_Base& other) : Ieee80211TwoAddressFrame()
{
    setName(other.getName());
    operator=(other);
}
...
void Ieee80211BlockAckFrameReq_Base::setBarAckPolicy(bool barAckPolicy_var)
{
    this->barAckPolicy_var = barAckPolicy_var;
}
...
void Ieee80211BlockAckFrameReq_Base::setMultiTid(bool multiTid_var)
{
    this->multiTid_var = multiTid_var;
}
...
void Ieee80211BlockAckFrameReq_Base::setCompressed(bool compressed_var)
{
    this->compressed_var = compressed_var;
}
...
void Ieee80211BlockAckFrameReq_Base::setTidInfo(unsigned short tidInfo_var)
{
    this->tidInfo_var = tidInfo_var;
}
...
void Ieee80211BlockAckFrameReq_Base::setFragNumber(unsigned short fragNumber_var)
{
    this->fragNumber_var = fragNumber_var;
}
...
void Ieee80211BlockAckFrameReq_Base::setStartingSequence(unsigned short startingSequence_var)
{
    this->startingSequence_var = startingSequence_var;
}
...
Ieee80211BlockAckFrame_Base::Ieee80211BlockAckFrame_Base(const Ieee80211BlockAckFrame_Base& other) : Ieee80211TwoAddressFrame()
{
    setName(other.getName());
    operator=(other);
}
...
void Ieee80211BlockAckFrame_Base::setBaAckPolicy(bool baAckPolicy_var)
{
    this->baAckPolicy_var = baAckPolicy_var;
}
...
void Ieee80211BlockAckFrame_Base::setMultiTid(bool multiTid_var)
{
    this->multiTid_var = multiTid_var;
}
...
void Ieee80211BlockAckFrame_Base::setCompressed(bool compressed_var)
{
    this->compressed_var = compressed_var;
}
...
void Ieee80211BlockAckFrame_Base::setTidInfo(unsigned short tidInfo_var)
{
    this->tidInfo_var = tidInfo_var;
}
...
void Ieee80211BlockAckFrame_Base::setStartingSequence(unsigned short startingSequence_var)
{
    this->startingSequence_var = startingSequence_var;
}
